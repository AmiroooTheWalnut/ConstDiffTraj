...
import V20 as MinimalisticModel

print(torch.cuda.is_available())
torch.autograd.set_detect_anomaly(True)
# torch.autograd.profiler.profile(enabled=True)

modelVersion="V20_real1_100_20_ADAM_LOSS_reduced_test3"
isTrainModel=True
continueTrain=True
...
visualize_extent(serializedSelected2DMatrix, data.shape[0], data, selectedOrNotSelected, saveName=None,serializedDirectPoint=selectedOrNotSelected)
...
# visualize_extent(serializedSelected2DMatrixs[0], datas[0].shape[0], datas[0], selectedOrNotSelecteds[0], saveName=None)
numPredicts = 500
