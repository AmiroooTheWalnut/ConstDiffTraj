...
class SimpleNN(nn.Module):
    def __init__(self, forbiddenSerialMap=None, lenForbidden=10, maxLengthSize = 10, temporalFeatureSize=2):
        ...
        self.trajInput = nn.Linear(temporalFeatureSize, 512)
        self.trajInputDirect = nn.Linear(temporalFeatureSize, 512)
        self.timeInput = nn.Linear(1, maxLengthSize * 512)
        self.mult1 = Multiply()
        self.conv1 = nn.Conv1d(512, 512, 7, padding=2)
        self.activation1 = nn.Sigmoid()
        self.conv2 = nn.Conv1d(512, 512, 5, padding=2)
        self.activation2 = nn.Sigmoid()
        self.conv3 = nn.Conv1d(512, 512, 3, padding=2)
        self.activation3 = nn.Sigmoid()
        # self.activation = Activation()
        self.lastDenseInPath = nn.Linear(512, 512)
        self.lastAdd = Add3()
        self.lastDense = nn.Linear(128 + 512, 512)
    ...
    def forward(self, traj, time):
        ...
        timePath = torch.reshape(timePath, (-1, self.maxLengthSize, 512))
        ...
        mergePath = self.lastDenseInPath(mergePath)
