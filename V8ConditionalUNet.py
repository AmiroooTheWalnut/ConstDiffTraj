...
class SimpleNN(nn.Module):
    def __init__(self, forbiddenSerialMap=None, lenForbidden=10, maxLengthSize = 10, temporalFeatureSize=2):
        ...
        self.e11 = nn.Conv1d(maxLengthSize+1, 64, kernel_size=3, padding=1)  # output: 570x570x64
    ...
    def forward(self, traj, time, condLat, condLon):
        ...
        mixedPlsPathCond = torch.cat((plsPath, condLat, condLon), 1)
        ...
        xe11 = self.activation(self.e11(trajPathAfterMultForbTime))
        ...
        finalPath = torch.cat((timePath, mergePath3Total, trajPathDirect,mergePath3Total,xd42), 2)
