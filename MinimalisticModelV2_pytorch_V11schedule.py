...
class SimpleNN(nn.Module):
    def __init__(self, forbiddenSerialMap=None, lenForbidden=10, maxLengthSize = 10, temporalFeatureSize=2):
        ...
        self.timeInput = nn.Linear(1, self.maxLengthSize*256)
        self.mult1 = Multiply()
...
def generate_ts(timesteps, num):
    ...
    lastOnes = np.random.randint((int)(math.floor(timesteps * 0.4)), timesteps, size=(int)(num / 2))
    lastOnes2 = np.random.randint((int)(math.floor(timesteps * 0.8)), timesteps, size=(int)(num / 1))
