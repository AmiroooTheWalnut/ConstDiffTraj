...
import MinimalisticModelV2_pytorch_V11schedule as MinimalisticModel
...
# [data,nGrid,selectedOrNotSelected,serializedSelected2DMatrix,_]=DataGeneratorFcn.generateSyntheticDataFixedLength(numTrajectories=numTrajectories,trajectoryLength=trajectoryLength,numGrid=40,seed=3,visualize=False)
...
def train(X_train, BATCH_SIZE,optim,cri, numIterates=30, isVisualizeLoss=False):
    ...
    total = 250
    scheduler1 = ExponentialLR(optimizer, gamma=0.998)
