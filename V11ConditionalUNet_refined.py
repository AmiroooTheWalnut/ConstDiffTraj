...
def generate_ts(timesteps, num):
    ...
    lastOnes2 = np.random.randint((int)(math.floor(timesteps*0.8)), timesteps, size=(int)(num / 2.4))
    lastOnes3 = np.random.randint((int)(math.floor(timesteps * 0.91)), timesteps, size=(int)(num / 1.15))
