...
def generate_ts(timesteps, num):
    ...
    lastOnes = np.random.randint((int)(math.floor(timesteps * 0.4)), timesteps, size=(int)(num / 1))
    lastOnes2 = np.random.randint((int)(math.floor(timesteps*0.8)), timesteps, size=(int)(num / 0.5))
    lastOnes3 = np.random.randint((int)(math.floor(timesteps * 0.91)), timesteps, size=(int)(num / 0.2))
    finalTsConcat = np.concat((orig,lastOnes,lastOnes2,lastOnes3))
    finalTs = np.random.choice(finalTsConcat,num)
    return finalTs
