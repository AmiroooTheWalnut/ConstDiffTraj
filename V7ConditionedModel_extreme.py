...
class SimpleNN(nn.Module):
    def __init__(self, forbiddenSerialMap=None, lenForbidden=10, maxLengthSize = 10, temporalFeatureSize=2):
        ...
        self.e11 = nn.Conv2d(maxLengthSize+1, 64, kernel_size=3, padding=1)  # output: 570x570x64
...
def generate_ts(timesteps, num):
    ...
    lastOnes = np.random.randint((int)(math.floor(timesteps*0.5)), timesteps, size=(int)(num/3))
    lastOnes2 = np.random.randint((int)(math.floor(timesteps * 0.95)), timesteps, size=(int)(num / 3))
