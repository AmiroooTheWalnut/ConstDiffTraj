...
class SimpleNN(nn.Module):
    def __init__(self, forbiddenSerialMap=None, lenForbidden=10, maxLengthSize = 10, temporalFeatureSize=2):
        ...
        self.psl = psl
        self.pslDense = nn.Linear(1, self.maxLengthSize*10)
        ...
        self.mult1 = Multiply()
        self.conv1d1 = nn.Conv1d(maxLengthSize, 64, 11, padding=5)
        ...
        self.conv1d2 = nn.Conv1d(maxLengthSize, 64, 11, padding=10, dilation=2)
        self.conv2d2 = nn.Conv1d(64, 64, 9, padding=8, dilation=2)
        self.conv3d2 = nn.Conv1d(64, 64, 7, padding=6, dilation=2)

        self.conv1d3 = nn.Conv1d(maxLengthSize, 64, 11, padding=15, dilation=3)
