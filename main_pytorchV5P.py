...
import V5ConditionedModel as MinimalisticModel
...
modelVersion="V5ConditionalModel"
isTrainModel=True
continueTrain=True
isRunOnCPU=False
numOptIterates=300
...
[dataT,nGrid,selectedOrNotSelectedT,serializedSelected2DMatrixT]=DataGeneratorFcn.generateSyntheticDataFixedLength(numTrajectories=numTrajectories,trajectoryLength=trajectoryLength,numGrid=40,seed=10,visualize=False)
